    ...
    return (
        <nav className='sm-h-[24px]'>
            <ul
                ...
                left-0 right-0 mx-auto top-[0] flex-col         items-center place-content-around
                after:content[""] after:absolute after:top-[-24px]      after:right-0 after:border-[12px] after:border-t-transparent after:border-l-transparent     after:border-b-white after:border-r-white      text-Dark-grayish-blue text-xl z-10 
                
                sm:flex sm:after:hidden sm:bg-transparent sm:flex-row sm-top-0 sm:w-[400px]  sm:h-full sm:py-0 sm:relative sm:nt-0 sm:text-white
